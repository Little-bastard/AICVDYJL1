...
class Toupcam:
    ...
    @classmethod
    def Version(cls):
        """get the version of this dll, which is: 55.24563.20240128"""
        cls.__initlib()
    ...
    def __initlib(cls):
        if cls.__lib is None:
            ...
            # cls.__lib.Toupcam_put_SelfTrigger.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.__SelfTrigger)]
            cls.__lib.Toupcam_get_SelfTrigger.restype = ctypes.c_int
            cls.__lib.Toupcam_get_SelfTrigger.errcheck = cls.__errcheck
            # cls.__lib.Toupcam_get_SelfTrigger.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.__SelfTrigger)]
            ...
            # cls.__lib.Toupcam_put_AFMode.argtypes = [ctypes.c_void_p, c_uint]
